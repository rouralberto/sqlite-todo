    ...
    public static function getCategories(array $array) {
        ...
        foreach ($array as $arrayitem) {
            ...
            $html .= <<< HTML
                      <tr>
                            <td>$counter</td>
                            <td><a class="editable" href="#" id="category" data-type="text" data-pk="$arrayitem[id]" data-url="categories" data-title="Edit Category" data-placement="right" data-placeholder="Category Name">$arrayitem[name]</a></td>
